...
print("\n --INÍCIO-------------------------1° ETAPA - DADOS - LEITURA DO DATASET COMPLETO------------------------------")
print(data_frame)
print(" --FIM-------------------------1° ETAPA - DADOS - LEITURA DO DATASET COMPLETO------------------------------")
time.sleep(2)
df = data_frame[['UDI', 'Air temperature [K]', 'Process temperature [K]', 'Rotational speed [rpm]', 'Torque [Nm]', 'Machine failure']]
print("\n --INÍCIO-------------------------2° ETAPA - DEFINIÇÃO DE DADOS DE INTERESSE------------------------------")
print(df)
print(" --FIM-------------------------2° ETAPA - DEFINIÇÃO DE DADOS DE INTERESSE------------------------------")
time.sleep(2)
print("\n --INÍCIO-------------------------ARRAY BUFFER PARA DATASET FILTRADO------------------------------")
t = np.zeros((len(df), 6), 'int')
print(t)
print("\n --FIM-------------------------ARRAY BUFFER PARA DATASET FILTRADO------------------------------")
print("\n --INÍCIO-------------------------3° ETAPA - PRÉ PROCESSAMENTO E ARMAZENAMENTO DO DATASET FILTRADO NO ARRAY BUFFER------------------------------")
...
print(t)
print(" --FIM-------------------------3° ETAPA - PRÉ PROCESSAMENTO E ARMAZENAMENTO DO DATASET FILTRADO NO ARRAY BUFFER------------------------------")
time.sleep(2)
...
X_test = p
y_test = d
print("\n --INÍCIO-------------------------4° ETAPA - FORMATAÇÃO E SEPARAÇÃO DE DADOS DE ENTRADA DA MLP------------------------------")
print("\n ---------------------------ENTRADAS - PARA ANÁLISE DA REDE NEURAL------------------------------")
print(p)
print("\n ---------------------------SAÍDAS - RESULTADOS SUPERVISIONADOS DE MOTOR COM OU SEM FALHA------------------------------")
print(d)
print(" --FIM-------------------------4° ETAPA - FORMATAÇÃO E SEPARAÇÃO DE DADOS DE ENTRADA DA MLP------------------------------")
time.sleep(2)
...
print("\n --INÍCIO-------------------------5° ETAPA - DEFINIÇÃO DE PADRÕES COM RNA SUPERVISIONADA------------------------------")
...
continuar = "sim"
while continuar == "sim":
    print("\n --INÍCIO-------------------------6° ETAPA - APLICAÇÃO EM PRODUÇÃO DO CONHECIMENTO COM RNA MLP TREINADA------------------------------")
    ...
    print("--FIM---------------------------6° ETAPA - APLICAÇÃO EM PRODUÇÃO DO CONHECIMENTO COM RNA MLP TREINADA------------------------------")
    time.sleep(2)
